...
# 2. Estilização CSS (Design Sentinela Dinâmico - APENAS VISUAL)
st.markdown("""
    <style>
    ...
    h1, h2, h3, b, strong, .stDownloadButton > button, [data-testid="stFileUploader"] button {
        font-family: 'Montserrat', sans-serif !important;
        font-weight: 800 !important;
    }
    
    h1 { color: #FF69B4 !important; text-align: center; margin-bottom: 20px; }
    ...
    [data-testid="stFileUploader"] { 
        border: 5px dashed #FF69B4 !important; 
        border-radius: 20px !important;
        background: #FFFFFF !important;
        padding: 30px !important;
    }

    /* BOTÕES: Rosa Vibrante Sólido */
