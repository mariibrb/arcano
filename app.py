...
if arquivo_subido and taxa_cambio > 0:
    ...
    if col_vlr and col_qtd:
        ...
        # --- AGREGAÇÃO FINAL (REGRAS MARIANA) ---
        ...
        params_pdf = {
            'v_prod_composto': v_prod_composto, 
            'outras_desp_total': outras_desp_total,
            'afrmm': outras_desp_total, 
            'v_ipi_tot': v_ipi_tot, 
            'v_icms_diferido': v_icms_diferido,
            'aliq_icms_val': aliq_icms, 
            'is_diferido': (tem_dif == "Sim"),
